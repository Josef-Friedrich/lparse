...
\subsubsection{Function “\texttt{scan_delimited(init_delim?, end_delim?): string}”}
...
The function \\ \lua{scan_delimited(init_delim,
end_delim)} allows to search for optional arguments not only
...
For example, this Lua code \lua{scan_delimited('(', ')')} searches for
...
After the \latex{\directlua{}}, the macro using \lua{scan_delimited}
