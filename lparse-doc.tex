...
\section{Function: \texttt{scan}}

\InputTex{luatex/function-scan.tex}

\section{Class: \texttt{Scanner}}

\subsection{Method: \texttt{Scanner:scan()}}

\subsection{Method: \texttt{Scanner:export()}}

\subsection{Method: \texttt{Scanner:assert()}}

\subsection{Method: \texttt{Scanner:debug()}}
